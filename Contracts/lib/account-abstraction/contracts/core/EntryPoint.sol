...
contract EntryPoint is IEntryPoint, StakeManager, NonceManager, ReentrancyGuard {
  ...
  function handleAggregatedOps(
    ...
    console.log("---------handleAggregatedOps");
  ...
  function simulateValidation(UserOperation calldata userOp) external {
    ...
    console.log("---------simulateValidation====================");
    _simulationOnlyValidations(userOp);
    console.log("_simulationOnlyValidations completed");
    (uint256 validationData, uint256 paymasterValidationData) = _validatePrepayment(0, userOp, outOpInfo);
    console.log("_validatePrepayment completed");
  ...
  function _validateSenderAndPaymaster(
    ...
    console.log("---------_validateSenderAndPaymaster");
  ...
  function _validatePaymasterPrepayment(
    ...
    console.log("_validatePaymasterPrepayment475");
    unchecked {
      MemoryUserOp memory mUserOp = opInfo.mUserOp;
    ...
    console.log("_validatePaymasterPrepayment 501 ok");
  }
